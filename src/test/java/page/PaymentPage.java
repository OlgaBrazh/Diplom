...
public class PaymentPage {
    ...
    public void getErrorCardNumberEmpty() {
        errorCardNumber.shouldHave(text("Поле обязательно для заполнения")).shouldBe(visible, Duration.ofSeconds(300));
    }
    ...
    public void getErrorYearExpired() {
        errorYear.shouldHave(text("Истёк срок действия карты")).shouldBe(visible, Duration.ofSeconds(15));
    }
