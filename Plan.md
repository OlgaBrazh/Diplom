...
- Ввести в поля формы валидные значения  
- Нажать "Продолжить"
...
*Шаги*:
1. Зайти на страницу http://localhost:8080
2. Ввести в поле "Номер карты" значение "3"
3. Заполнить валидными значениями остальные поля формы
4. Нажать "Продолжить"
...
*Ожидаемый результат*:   
Уведомление о неверности формата поля "Месяц".
...
*Шаги*:
1. Зайти на страницу http://localhost:8080
2. Поле "Месяц" заполнить значением месяца, опережающего текущую дату на 6 месяцев (например, 10).
3. Поле "Год" заполнить значением года, опережающего текущую дату на 6 месяцев (например, 22)
3. Заполнить валидными значениями остальные поля формы.
4. Нажать "Продолжить"
...
1. Зайти на страницу http://localhost:8080
2. Нажать "Купить в кредит"
3. Поле "Месяц" заполнить значением месяца, опережающего текущую дату на 6 месяцев (например, 10).
4. Поле "Год" заполнить значением года, опережающего текущую дату на 6 месяцев (например, 22)
...
*Ожидаемый результат*:   
Уведомление о неверности формата поля "Год".
...
*Шаги*:
1. Зайти на страницу http://localhost:8080
2. Поле "Месяц" заполнить значением месяца, опережающего текущую дату на 1 год (например, 04).
3. Поле "Год" заполнить значением года, опережающего текущую дату на 1 год (например, 22)
4. Заполнить валидными значениями остальные поля формы.
5. Нажать "Продолжить"
...
1. Зайти на страницу http://localhost:8080
2. Нажать "Купить в кредит"
3. Поле "Месяц" заполнить значением месяца, опережающего текущую дату на 1 год (например, 04).
4. Поле "Год" заполнить значением года, опережающего текущую дату на 1 год (например, 22)
5. Заполнить валидными значениями остальные поля формы.
6. Нажать "Продолжить"
